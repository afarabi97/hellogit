...
RUN apt-get update && apt-get dist-upgrade -y && apt-get install -y \
    apache2 apache2-doc apache2-utils libapache2-mod-shib libapache2-mod-auth-openidc libapache2-mod-php php php-dev php-json \
    php-mysql php-redis php-xml php-mbstring php-gd php-pear php-opcache pkg-config libbson-1.0 libmongoc-1.0-0 python3-dev python3-pip \
    python3-setuptools python3-lxml libjpeg-dev libxml2-dev libxslt1-dev zlib1g-dev libfuzzy-dev cron logrotate supervisor syslog-ng-core \
