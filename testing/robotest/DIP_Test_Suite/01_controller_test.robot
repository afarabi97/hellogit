...
*** Test Cases ***
Navigate To DIP Controller THISISCVAH-6613
...
Open Chrome
    ...
    Open Browser    https://giphy.com/gifs/test-testing-r7riLSvkCAgSI/fullscreen  browser=${BROWSER}  desired_capabilities=${options}
...
Open Firefox
    [Arguments]     ${BROWSER}
    Open Browser    https://giphy.com/gifs/test-testing-r7riLSvkCAgSI/fullscreen  browser=${BROWSER}
