...
def wait_for_jobs_to_complete(deployments: list, master_srv: NodeSettings, timeout_minutes: int=10):
    """
...
def wait_for_deployments_to_ready(deployments: list, master_srv: NodeSettings, timeout_minutes: int=10):
    """
    This functions waits for all the current Jobs in the Kubernetes cluster to be complete before continuing.
    It will time out after a period of time
