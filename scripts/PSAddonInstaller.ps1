...
$modules = @(
	...
	"CIF3:0.9.7",
	"CimSweep:0.6.0.0",
	"CloudConnect:0.5.0", #Downgraded, project has been depricated with notes "the underlying module is no longer supported by Microsoft"
	"ComputerManagementDsc:8.5.0-preview0001",
	"CYB3RTools:2.2.1",
	"DSInternals:4.4.1",
	"ESENT:1.0.0.1",
	"ExchangeOnlineManagement:2.0.5-Preview1",
	"FileSystemDsc:1.2.0-preview0003",
	"HardenedPS:0.0.1",
	"Hardening:1.0.1",
	"HAWK:2.0.3.2",
	"MSOnline:1.1.183.66",
