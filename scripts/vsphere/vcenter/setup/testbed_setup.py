...
import vsphere.vcenter.setup.backend_directory as backend_directory
import vsphere.vcenter.setup.cluster as cluster
import vsphere.vcenter.setup.datacenter as datacenter
import vsphere.vcenter.setup.datastore as datastore
import vsphere.vcenter.setup.floppy_image as floppy_image
import vsphere.vcenter.setup.folder as folder
import vsphere.vcenter.setup.host as host
import vsphere.vcenter.setup.iso_image as iso_image
import vsphere.vcenter.setup.network as network
