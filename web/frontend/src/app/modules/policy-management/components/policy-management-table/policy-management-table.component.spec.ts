...
import { PolicyManagementTableComponent } from './policy-management-table.component';
...
describe('PolicyManagementTableComponent', () => {
  let component: PolicyManagementTableComponent;
  let fixture: ComponentFixture<PolicyManagementTableComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PolicyManagementTableComponent);
  ...
  it('should create PolicyManagementTableComponent', () => {
    expect(component).toBeTruthy();
  });

  describe('PolicyManagementTableComponent methods', () => {
    describe('ngOnInit()', () => {
    ...
    describe('edit_rule()', () => {
      ...
      it('should call rules_service_.set_edit_rule() from edit_rule()', () => {
        reset();

        component.edit_rule(MockRuleSetClass, MockRuleClass);

        expect(component['rules_service_'].set_edit_rule).toHaveBeenCalled();
      });

      it('should call rules_service_.set_edit_rule_set() from edit_rule()', () => {
        reset();

        component.edit_rule(MockRuleSetClass, MockRuleClass);

        expect(component['rules_service_'].set_edit_rule_set).toHaveBeenCalled();
      });

      it('should call rules_service_.set_is_user_adding() from edit_rule()', () => {
        reset();

        component.edit_rule(MockRuleSetClass, MockRuleClass);

        expect(component['rules_service_'].set_is_user_adding).toHaveBeenCalled();
      });

      it('should call rules_service_.set_is_user_editing() from edit_rule()', () => {
        reset();
    ...
    describe('add_rule()', () => {
      ...
      it('should call rules_service_.set_edit_rule_set() from add_rule()', () => {
        reset();
