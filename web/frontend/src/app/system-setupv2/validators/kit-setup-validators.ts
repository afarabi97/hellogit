...
export const kitSettingsValidators = {
  ...
  domain: [
    { ops: { pattern: /^[a-z]([a-z0-9-]){2,51}$/ }, error_message: 'Domain must be alphanumeric and 52 characters or less. Special characters are not allowed with the exception of dashes (IE -).', validatorFn: 'pattern' },
