...
export const kitSettingsValidators = {
  ...
  domain: [
    { ops: { pattern: /^[a-z]([a-z0-9-]){2,39}$/ }, error_message: 'Domain must be alphanumeric and less than 41 characters. Special characters are not allowed with the exception of dashes (IE -).', validatorFn: 'pattern' },
...
export const addNodeValidators = {
  hostname: [
    ...
    { ops: { pattern: /^[a-z]([a-z0-9-.]){4,39}$/ }, error_message: 'Hostname must be alphanumeric and less than 41 characters. Special characters are not allowed with the exception of dashes (IE -).', validatorFn: 'pattern' },
