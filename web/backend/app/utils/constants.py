...
ZEEK_IMAGE_VERSION = "4.0.5"
ARKIME_IMAGE_VERSION = "3.1.0"
BEATS_IMAGE_VERSIONS = "7.16.3"
WINLOGBEAT_IMAGE_VERSIONS = "7.15.2"
...
NODE_STATE_ADMIN = "controller-node-state"
METRICS_ROLE = "metrics"

METRICS_ROLES = [OPERATOR_ROLE, CONTROLLER_ADMIN_ROLE, CONTROLLER_MAINTAINER_ROLE, REALM_ADMIN_ROLE, METRICS_ROLE]
DEFAULT_REQUIRED_ROLES = [OPERATOR_ROLE, CONTROLLER_ADMIN_ROLE, CONTROLLER_MAINTAINER_ROLE, REALM_ADMIN_ROLE]
NODE_STATE_ADMIN_ROLES = [OPERATOR_ROLE, CONTROLLER_ADMIN_ROLE, CONTROLLER_MAINTAINER_ROLE, REALM_ADMIN_ROLE, NODE_STATE_ADMIN]
