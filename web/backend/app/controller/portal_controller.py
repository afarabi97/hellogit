...
class PortalLinksCtrlApi(Resource):
    ...
    @PORTAL_NS.response(200, "List PortalLinkModel", [PortalLinkModel.DTO])
...
class UserLinksCtrlApi(Resource):
    ...
    @PORTAL_NS.response(200, "List UserPortalLinkModel", [UserPortalLinkModel.DTO])
    ...
    @PORTAL_NS.response(200, "List UserPortalLinkModel", [UserPortalLinkModel.DTO])
    @PORTAL_NS.response(500, "ErrorMessage: InternalServerError", COMMON_ERROR_MESSAGE)
    @PORTAL_NS.expect(UserPortalLinkModel.DTO)
    @required_params(UserPortalLinkSchema())
    @operator_required
    @handle_errors
