...
def test_delete_notifications_del_200(client: FlaskClient, mocker: MockerFixture) -> None:
    mocker.patch("app.controller.notification_controller.delete_notifications", return_value=mock_success_message)
...
def test_delete_notifciation_id_200(client: FlaskClient, mocker: MockerFixture) -> None:
    ...
    mocker.patch("app.controller.notification_controller.delete_notification_id", return_value=mock_success_message)
